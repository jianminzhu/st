...
this file except in compliance with the License. You may obtain a deepCopy of the
...
interface JQueryStatic {
     ...
     * Merge the contents of two or more objects together into the first object.
     *
     * @param deep If true, the merge becomes recursive (aka. deep deepCopy).
...
interface JQuery {
    ...
    */
    ...
    /**
     * Create a deep deepCopy of the set of matched elements.
     * 
