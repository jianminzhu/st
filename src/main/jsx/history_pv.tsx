    ...
    $(function () {
        ...
        afterLoad(["js/echarts/echarts3_all.min.js", "jsx/DeepCopyUtil.js", "jsx/RQueryWords.js"], function () {
            ...
            if (pvOrCtr == "PV" || pvOrCtr == "pv") {
                ...
                ReactDOM.render(<RSelect {...r_select}/>, document.getElementById("jingque_mohu_select"))
            }
            ...
            ReactDOM.render(<RQueryWords {...dquerywordsProp}/>, document.getElementById("d_query_words"))
