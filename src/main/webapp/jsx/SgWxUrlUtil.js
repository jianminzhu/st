 ...
 */
var SgWxUrlUtil = (function () {
    function SgWxUrlUtil() {
        this.KEY_MD5 = "__md5__";
        this.srcMd5UrlMap = {};
        this.decryptMd5UrlMap = {};
    }
    SgWxUrlUtil.prototype.doA = function (decodeUrl, isOpenInNew) {
        if (isOpenInNew) {
     ...
     * @returns {Array}
     */
    SgWxUrlUtil.prototype.madeToEncObjArr = function (hrefOrEncObjs) {
        var encObjArr = [];
        var v = this;
        var appendMd5 = {};
    ...
    SgWxUrlUtil.prototype.appendEncObj = function (encObjArr, url, appendMd5) {
    ...
    SgWxUrlUtil.prototype.isWxUrl = function (url) {
        var url = url || "";
        return (url.indexOf("mp.weixin.qq.com") != -1) && (url.indexOf("signature=") != -1) && (url.indexOf("timestamp=") != -1);
    };
    SgWxUrlUtil.prototype.notDecrypt = function (md5) {
        try {
    ...
    SgWxUrlUtil.prototype.decodeUrl = function (hrefOrEncObjs, timeout) {
        var v = this;
        var dtd = $.Deferred();
    ...
    SgWxUrlUtil.prototype.dealWxUrls = function (jroot) {
        var v = this;
        var urls = [];
    ...
    SgWxUrlUtil.prototype.dealAllEncUrl = function (jroot) {
        var v = this;
        ...
        (function ($) {
            $(function () {
                ...
                $("body").on('click', 'a[data-wxhref]', function (e) {
                    ...
                    if (decUrl != "" && decUrl != "javascript:void(0)") {
                        return;
                    }
                    else {
...
//# sourceMappingURL=SgWxUrlUtil.js.map