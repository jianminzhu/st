...
(function ($) {
    $(function () {
        ...
        ReactDOM.render(React.createElement(RSelect, __assign({}, query_uid_select)), document.getElementById("query_uid_select"));
        dealChannelType();
            ...
            searchtools_isPassStEtDateCheck(p, function () {
                if ((p.query || p.uid) && p.st && p.et) {
                    ...
                    head.load(["jsx/RSession.js", "jsx/RSessionAll.js"], function () {
                        ReactDOM.render(React.createElement(RSessionAll, __assign({}, props)), document.getElementById("d_session_all"));
                    });
                }
            });
        };
