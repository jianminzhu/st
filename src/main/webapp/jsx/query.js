...
var changeWeekStEt = function (et, rType) {
    if (rType == "week") {
        var et_day = et || "";
        var ymd = "YYYYMMDD";
        if (_.trim(et_day) == "") {
...
(function ($, num_ctr, num_average_click_position, SEARCHTOOLS_API_SERVER, UrlUtil, QueryTable, kkpager, moment, window) {
    $(function () {
        ...
        ReactDOM.render(React.createElement(RSelect, __assign({}, jingque_mohu_select)), document.getElementById("jingque_mohu_select"));
        //根据日期动态生成表格配置
