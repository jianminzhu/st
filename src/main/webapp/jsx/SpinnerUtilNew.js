var SpinnerUtilNew = (function () {
    function SpinnerUtilNew(opts, spinnerId) {
        this.opts = {
    ...
    SpinnerUtilNew.prototype.show = function () {
        ++this.count;
        this.spinner.spin(this.target);
    };
    SpinnerUtilNew.prototype.hide = function () {
        --this.count;
        if (this.count == 0) {
            this.spinner.stop();
        }
    };
    return SpinnerUtilNew;
}());
//# sourceMappingURL=SpinnerUtilNew.js.map